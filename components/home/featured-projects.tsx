            ...
            {featuredProjects.map((project, index) => (
              ...
              >
                <div className="group h-full">
                  <Card className="h-full flex flex-col overflow-hidden border-2 transition-all hover:border-primary relative">
                    ...
                    <CardFooter className="flex gap-2 z-20 relative bg-background">
